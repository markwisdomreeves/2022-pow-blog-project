                  ...
                  <article>
                    ...
                    <div>
                      ...
                      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div id="profile_section_one" className="-mt-12 sm:-mt-16
                         sm:flex sm:items-end sm:space-x-5">
                          ...
                          {/* section one */}
                          <div className="
                          mt-6 sm:flex-1 sm:min-w-0 sm:flex
                          sm:items-center sm:justify-end
                          sm:space-x-6 sm:pb-1"
                          >
                            <div className="
                            flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                              <h1 className="text-2xl font-bold text-gray-900 ">
                                {profile?.firstName} {profile?.lastName}
                                <span className="inline-flex items-center px-3 py-0.5 ml-8 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">
                                  {profile?.accountType}
                                </span>
                              ...
                              <p className="text-yellow-600 text-sm mt-2 mb-2 inline-block">
                              ...
                              <div className="custom_bio_profile_container">
                                <h5>{profile?.bio}</h5>
                              </div>
                             </div>
                            ...
                            {/* section two */}
                            <div id="profile_section_two" className="mt-6 flex flex-col justify-stretch space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                          ...
                          profile?.posts?.map(post => (
                            <div className="flex flex-wrap -mx-3 mt-3 lg:mb-6">
                              ...
                              <div className="w-full lg:w-3/4 px-3">
                                ...
                                >
                                  <h3 className="mb-1 text-2xl text-yellow-600 font-bold font-heading">
                                    {post?.title}
                                  </h3>
                                </Link>

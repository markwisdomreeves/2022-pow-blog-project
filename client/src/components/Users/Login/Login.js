          ...
          <div className="max-w-5xl mx-auto">
            <div className="flex flex-wrap items-center -mx-4">
              <div className="w-full lg:w-2/5 px-4">
                <div className="px-6 lg:px-12 py-12 lg:py-24 bg-white shadow-lg rounded-lg" id="small_h3_font">
                  {/* Form */}
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="flex items-center pl-6 mb-3 border border-gray-50 bg-white rounded-full">
                      ...
                      <input
                        ...
                        className="sm:text-sm w-full pr-6 pl-4 py-4 font-bold placeholder-gray-300 rounded-r-full focus:outline-none"
                        type="email"
                    ...
                    {loading ? (
                      ...
                      <button
                        type="submit"
                        className="py-4 w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold rounded-full transition duration-200"
                      >
                        Login
                      </button>
                    )}
                  </form>
                  <div className="p-2 login_button_container" id="small_link_font">
                    {/* <Link to="/register" className="login_link_log">
                      Register
                    </Link> */}
                    <Link to="/password-reset-token" className="login_link_log">
                      Forgot Password?
                    </Link>
                  </div>
                </div>
              </div>
              <div className="w-full lg:w-3/5 px-4 mb-16 lg:mb-0 order-first lg:order-last" id="small_h2_font">
                ...
                <h2 className="mb-10 text-center text-5xl lg:text-6xl text-gray-300 font-bold font-heading">

...
const ResetPasswordForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8" id="main_custom_reset_password_styles">
      <div className="max-w-md w-full space-y-8" id="custom_reset_password_styles">
        <div>

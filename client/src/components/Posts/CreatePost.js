...
// import EditorToolbar, { modules, formats } from "../ReactEditor/EditorToolbar";
// import "react-quill/dist/quill.snow.css";
// import "../ReactEditor/TextEditor.css";
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            <p className="font-medium text-green-600 hover:text-green-500">
              ...
              <br />
              Your article must be free from
              profanity
            </p>
          </p>
            ...
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  type="text"
                  placeholder={"Writer something great..."}
                ></textarea>
                {/* Image component */}
                <label
                  htmlFor="password"
              ...
              <div>
                ...
                {loading ? (
                  <button
                    disabled
                    className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-600  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500"
                  >
                    Loading please wait...
                  </button>
                ) : (

...
const followingUserCtrl = expressAsyncHandler(async (req, res) => {
  ...
  if (alreadyFollowing) throw new Error("You have already followed this person");
  ...
  res.json("You have successfully followed this person");
});
...
const unfollowUserCtrl = expressAsyncHandler(async (req, res) => {
  ...
  res.json("You have successfully unfollowed this person");
});
